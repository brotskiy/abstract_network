...
#### 4.4.1.1. Потоки данных, стек протоколов, механизм сокетов и мультиплексирование соединений
...
#### 4.4.1.2. Установление соединения и передача данных
