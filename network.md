...
Ethernet НЕ является надёжным протоколом и использует только проверку контрольной CRC-суммы кадры - он не устанавливает соединения и не отправляет подтверждения.
...
+ **Checksum** - поле контрольной суммы с CRC-кодом *всего пакета*, включая заголовок и данные; несоответствие CRC-кода вынуждает получателя просто уничтожить поврежденный кадр.
