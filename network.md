...
### 5.2.1. Физический адрес - MAC. Пакеты Ethernet
...
### 5.2.2. Отображение MAC на IP-адрес. Протоколы ARP и RARP
...
### 5.2.3. Групповая адресация в локальных сетях Ethernet
