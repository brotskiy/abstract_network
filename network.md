...
Ядро сети состоит из множества различных *каналов связи* и *пакетных свитчей*, соединящих сети доступа друг с другом. Два основных типа свитча - **маршрутизатор (router)**, действующий на *сетевом* уровне, и **коммутатор (link-layer switch)**, действующий на *канальном* уровне.
