...
При заполнении *forwarding-таблицы* маршрутизатор определяет, какой из его соседних узлов достигает минимума в уравнении Беллмана-Форда для искомого узла назначения - т.е. какому следующему узлу необходимо передать датаграмму для обеспечения её следования по наиболее оптимальному пути. Однако описанный принцип функционирования distance-vector алгоритма сам по себе не гарантирует отсутствие циклов в путях. Напротив, обновление некоторым узлом собственного вектора расстояний и анонсирование его соседям, сопровождающееся получением вектора соседа, может привести к повторному обновлению собственного вектора и новому анонсированию - такой устойчивый обмен информацией, способный продолжаться неопределенно долгое время в зависимости от текущей конфигурации ребер, получил название **count-to-infinity problem**. Для противодействия возникновению циклов требуются дополнительные механизмы. Одним из них является **poisoned reverse**, заключающийся в требовании к узлу *x*, достигающему точку назначения *z* через узел *y*, анонсировать ему, что путь из *x* в *z* имеет бесконечную стоимость. Это гарантирует, что *y* для своего пути в *z* никогда не будет использовать *x*, и ситуация, когда датаграмма непрерывно переадресуется между двумя узлами до истечения её времени жизни, становится невозможной. Однако по-прежнему могут возникать циклы из трёх и более узлов.
