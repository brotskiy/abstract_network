...
+ использование алгоритмов **замедленного старта** (постепенное увеличение объёма передаваемых данных) и **контроля за перегрузкой сети** (ограничение скорости передачи данных в соответствии с пропускной способностью сети);
