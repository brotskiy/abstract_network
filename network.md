...
IP-адрес отражает концепцию сети, образованной хостами и другими сетями, и обладает *иерархической структурой*, включающей в себя 2 или 3 части: **адрес сети**, **адрес подсети** (если он задан) и **адрес конечного узла** (сетевого интерфейса). Под адресацию сетей отводятся старшие биты, а под адресацию узлов - младшие. *Префикс сети/подсети* извлекается из адреса наложением (бинарное И) **маски сети/подсети**, состоящей из непрерывной последовательностей единиц, дополненной нулями до размера адреса. Изначально все IPv4-адреса разделялись на несколько непересакающихся диапазонов, называемых *классами*, в каждом из которых под *префикс сети* отводилось свое *фиксированное* число битов: 8, 16 или 24. Конкретный класс определялся по первым битам адреса, являющимся своеобразным маркером.
