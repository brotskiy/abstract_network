...
**Transmission Control Protocol** является *надежным* транспортным протоколом, который основывается на установлении долговременного *соединениния* и предоставляет двунаправленный канал взаимодействия *двух конечных точек*, состоящий из входящего и исходящего *потоков байт*. TCP гарантирует:
