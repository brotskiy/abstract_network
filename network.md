...
Центральной частью маршрутизации IP является таблица маршрутов датаграмм, которая устанавливается на каждом хосте сети и используется при выборе следующей сети, куда будет направлена датаграмма. Для построения и настройки этих таблиц используются различные динамические, векторные и другие протоколы маршрутизации.
