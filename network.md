...
+ использование алгоритмов **замедленного старта** (постепенное увеличение объёма передаваемых данных) и **контроля над перегрузкой сети** (ограничение скорости передачи данных в соответствии с рассчитываемой пропускной способностью сети);
...
### 3.4.6. Равномерное распределение траффика
