...
Поиск минимального пути в графе может осуществляться различными способами - приведем описание **алгоритма Дейкстры** (Эдсгер Дейкстра), который строит **минимальное остовное дерево** - подграф с минимальной суммой весов ребер, содержащий все вершины исходного графа. Стоимости рёбер при этом должны быть неотрицательными - как раз случай реальной сети. Сутью данного алгоритма является итеративное расширение доступной для посещения из произвольной начальной вершины области графа, сопровождающееся заполнением множества вершин, для которых минимальный путь уже гарантированно найден, и расчетом оценок стоимостей путей до оставшихся вершин. Обозначения:
