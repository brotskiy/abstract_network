...
**Сетевой протокол** - набор правил, определяющий формат и порядок сообщений, которыми обмениваются два или более участника сетевого общения, а также действия, выполняемые при получении или отправке сообщения. **Интернет** - сеть компьютерных сетей. Включает в себя различные физические сети и предоставляет всем подключенным компьютерам унифицированную сетевую архитектуру. Интернет функционирует на основе набора протоколов: TCP, UDP, ARP, ICMP, TELNET, FTP, IP, HTTP и другие. Общепринятое название данного набора - **семейство протоколов TCP/IP**.
