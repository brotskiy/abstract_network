...
+ **Urgent data pointer** - если установлен бит `URG`, то данное поле определяет местоположение последнего байта **внеканальных (out-of-band)** данных в сегменте; в настоящее время **не используется**;
