...
+ **flow control** - *контроль потока*; ограничивает отправителя до скорости, с которой получатель способен принимать данные без потерь, вызванных переполнением входных буферов;
+ **congestion control** - *контроль за перегрузкой*; ограничивает отправителя, чтобы его траффик эксклюзивно не занял всю пропускную способность канала, тем самым заблокировав работу других сетевых приложений.
